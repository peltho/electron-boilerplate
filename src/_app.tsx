                ...
                <div className="card">
                    ...
                    <div className="mt-5 flex flex-row">
                        <div className="basis-1/5">
                            <ThumbUpIcon className="h-5 w-5 text-gray-400 inline-block"/><div className="mx-2 text-sm font-bold mr-10 inline-block">29</div>
                        </div>
                        <div className="basis-1/5">
                            <ChatAltIcon className="h-5 w-5 text-gray-400 inline-block" /><div className="mx-2 text-sm font-bold mr-10 inline-block">11</div>
                        </div>
                        <div className="basis-1/5">
                            <EyeIcon className="h-5 w-5 text-gray-400 inline-block"/><div className="mx-2 text-sm font-bold mr-10 inline-block">2.9k</div>
                        </div>
